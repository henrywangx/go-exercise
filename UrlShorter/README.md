...
```bash
go build -o short && ./short
```

Then visit the `localost:8080` with url `baidu`, `sina` and any other urls.
It will redirect to the right website defined in `redirect.yaml`.
## Exercise details
